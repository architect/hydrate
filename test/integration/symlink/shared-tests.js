...
test(`[Shared file symlinking (default paths)] shared() never uses symlinks by default`, async () => {
  await new Promise((resolve) => {
    resetAndCopyShared(function () {
      hydrate.shared({ symlink }, function (err) {
        ...
        assert.ok(stat, 'shared directory is a symlink')
        assert.strictEqual(readFileSync(file).toString(), 'It me!', 'Symlinked file is readable')
        resolve()
      })
    })
  })
...
test(`[Shared file symlinking (custom paths)] shared() never uses symlinks by default`, async () => {
  await new Promise((resolve) => {
...
test(`[Shared file symlinking (default paths)] shared() copies shared and views (unless disabled or folder not found; @views not specified)`, async () => {
  await new Promise((resolve) => {
    resetAndCopyShared(function () {
      hydrate.shared({ symlink }, function (err) {
        if (err) assert.fail(err)
...
test(`[Shared file symlinking with plugins (default paths)] shared() copies shared and views, as well as files via plugin`, async () => {
  await new Promise((resolve) => {
...
test(`[Shared file symlinking (custom paths)] shared() copies shared and views (unless disabled or folder not found; @views not specified)`, async () => {
  await new Promise((resolve) => {
    resetAndCopySharedCustom(function () {
      hydrate.shared({ symlink }, function (err) {
        if (err) assert.fail(err)
...
test(`[Shared file symlinking (default paths)] shared() views to only @views (unless disabled or folder not found)`, async () => {
  await new Promise((resolve) => {
    resetAndCopyShared(function () {
...
test(`[Shared file symlinking (custom paths)] shared() views to only @views (unless disabled or folder not found)`, async () => {
  await new Promise((resolve) => {
    resetAndCopySharedCustom(function () {
...
test(`[Shared file symlinking (default paths)] shared() copies static.json but not app.arc (Arc v6+)`, async () => {
  await new Promise((resolve) => {
    resetAndCopyShared(function () {
      hydrate.shared({ symlink }, function (err) {
        if (err) assert.fail(err)
...
test(`[Shared file symlinking (custom paths)] shared() copies static.json but not app.arc (Arc v6+)`, async () => {
  await new Promise((resolve) => {
    resetAndCopySharedCustom(function () {
      hydrate.shared({ symlink }, function (err) {
        if (err) assert.fail(err)
...
test(`[Shared file symlinking (default paths)] shared() copies static.json with @static folder configured`, async () => {
  await new Promise((resolve) => {
    resetAndCopyShared(function () {
...
test(`[Shared file symlinking (custom paths)] shared() copies static.json with @static folder configured`, async () => {
  await new Promise((resolve) => {
    resetAndCopySharedCustom(function () {
      // Rewrite app.arc to include @static folder directive
      let arcFile = join(process.cwd(), 'app.arc')
...
test(`[Shared file symlinking (default paths)] shared() should remove files in functions that do not exist in shared and views`, async () => {
  await new Promise((resolve) => {
    resetAndCopyShared(function () {
...
test(`[Shared file symlinking (custom paths)] shared() should remove files in functions that do not exist in shared and views`, async () => {
  await new Promise((resolve) => {
    resetAndCopySharedCustom(function () {
      let sharedStragglers = sharedArtifacts.map((p) => {
        let dir = dirname(p)
