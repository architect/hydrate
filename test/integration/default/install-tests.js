...
test(`[Default (file copying)] install() hydrates all Functions', shared and views dependencies (autoinstall enabled)`, async () => {
...
test(`[Default (file copying)] install() hydrates all Functions', shared and views dependencies (autoinstall enabled, no package files in shared)`, async () => {
  await new Promise((resolve) => {
...
test(`[Default (file copying)] install (specific path / single path) hydrates only Functions found in the specified subpath`, async () => {
  await new Promise((resolve) => {
    resetAndCopyShared(function () {
...
test(`[Default (file copying)] install (specific path / single path) in a manifest-free Node.js function adds missing deps with autoinstall enabled`, async () => {
  await new Promise((resolve) => {
    resetAndCopyShared(function () {
...
test(`[Default (file copying)] install (specific path / single path) in a manifest-free Node.js function does not add missing deps with autoinstall disabled`, async () => {
  await new Promise((resolve) => {
    resetAndCopyShared(function () {
      let basepath = nodeFunctions[1]
...
test(`[Default (file copying)] install() should not recurse into Functions dependencies and hydrate those`, async () => {
  await new Promise((resolve) => {
    reset(function () {
